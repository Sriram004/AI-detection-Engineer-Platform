...
Built an AI-assisted SOC investigation and detection engineering platform using Python, Streamlit, FastAPI, SQLite, MITRE ATT&CK, Sigma, and Microsoft Sentinel KQL. The tool analyzes security alerts, maps activity to ATT&CK techniques, generates detection logic, stores analyst validation, and exports incident reports.
